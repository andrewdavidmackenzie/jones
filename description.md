...
Currently not supported by Jonesy, but debuggers like `lldb` can read debug info directly from object files using the debug map in the binary. This would eliminate all extra steps.
